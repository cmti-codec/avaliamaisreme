...
export default function Coordenadores() {
  ...
  const getCargaTotalCoordenador = (pessoa: any) => {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold">Coordenadores (REME)</h1>
          <p className="text-muted-foreground mt-2">
            Gerencie coordenadores da REME e suas lotações nas escolas da rede
          </p>
        </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Coordenadores ({pessoas.length})</CardTitle>
          <CardDescription>
            Lista de coordenadores da Rede Municipal de Ensino
          </CardDescription>
        </CardHeader>
        <CardContent>
          {isLoading ? (
            ...
            <div className="text-center py-8 text-muted-foreground">
              ...
              <p>Nenhum coordenador encontrado com os filtros selecionados</p>
            </div>
          ) : (
            <div className="overflow-x-auto">
              <Table>
                ...
                <TableBody>
                  {pessoas.map((pessoa) => {
                    const cargaTotal = getCargaTotalCoordenador(pessoa);
