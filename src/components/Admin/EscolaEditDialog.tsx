...
interface EscolaEditDialogProps {
  escola: any;
  open: boolean;
  onOpenChange: (open: boolean) => void;
}

export function EscolaEditDialog({ escola, open, onOpenChange }: EscolaEditDialogProps) {
  ...
  useEffect(() => {
    if (escola) {
      setFormData({
        ...
        codigo_saesc: escola.codigo_saesc || "",
        tipo: escola.tipo || "",
