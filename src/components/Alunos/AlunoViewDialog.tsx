...
const situacaoMap: Record<string, {
  label: string;
...
export const AlunoViewDialog = ({
  aluno,
  open,
  onOpenChange
}: AlunoViewDialogProps) => {
  if (!aluno) return null;
  const situacao = aluno.desoca || "FREQUENTE";
  const situacaoConfig = situacaoMap[situacao] || {
    label: situacao,
  ...
  return <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="font-medium text-foreground">
                  {aluno.datmtr ? format(new Date(aluno.datmtr), "dd 'de' MMMM 'de' yyyy", {
                  locale: ptBR
                }) : "-"}
                </p>
              </div>
          ...
          <div>
            <h3 className="text-lg font-semibold mb-3 text-foreground">Informações Escolares</h3>
            <div className="grid grid-cols-2 gap-4">
              <div>
          ...
          {(aluno.sioca || aluno.dtomtrc) && <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                {aluno.dtomtrc && <div>
                    ...
                    <p className="font-medium text-foreground">
                      {format(new Date(aluno.dtomtrc), "dd/MM/yyyy", {
                  locale: ptBR
                })}
                    </p>
                  </div>}
